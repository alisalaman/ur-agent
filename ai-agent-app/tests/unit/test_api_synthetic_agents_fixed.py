...
class TestSyntheticAgentsAPI:
    ...
    def test_query_agent_success(self, client, mock_persona_service):
    ...
    def test_query_agent_service_error(self, client, mock_persona_service):
    ...
    def test_query_all_agents_success(self, client, mock_persona_service):
    ...
    def test_get_agent_status_success(self, client, mock_persona_service):
        ...
        data = response.json()
        assert len(data) == 2
        assert any(item["persona_type"] == "BankRep" for item in data)
        assert any(item["persona_type"] == "TradeBodyRep" for item in data)

    def test_clear_agent_cache_specific_persona(self, client, mock_persona_service):
        ...
        assert "BankRep" in data["message"]

    def test_clear_agent_cache_all(self, client, mock_persona_service):
    ...
    def test_health_check_success(self, client, mock_persona_service):
    ...
    def test_health_check_error(self, client, mock_persona_service):
